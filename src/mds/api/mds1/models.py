""" 
Utilities for mapping 1.x models into the new api. Mapped classes should extend 
ApiMap and implement api_map.
...
from sana.api.mds1 import ApiMap

GUID_LENGTH = 512

class Client(models.Model, ApiMap):
...
class Patient(models.Model, ApiMap):
    name = models.CharField(max_length=512)
...
class Procedure(models.Model, ApiMap):
...
class BinaryResource(models.Model, ApiMap):
...
class SavedProcedure(models.Model, ApiMap):
...
class Notification(models.Model, ApiMap):
